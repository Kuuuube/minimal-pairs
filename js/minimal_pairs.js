...
function update_answer_buttons(json_data) {
    ...
    json_data["pairs"].forEach(function(currentValue, index, _) {
        let raw_pronunciation = currentValue["entries"][0]["pronunciations"][0]["phrases"][0]["rawPronunciation"];
        let accented_mora = currentValue["entries"][0]["pronunciations"][0]["phrases"][0]["accentedMora"];
        ...
        let sound_data = currentValue["entries"][0]["pronunciations"][0]["soundData"];
...
function update_audio(json_data) {
    let pairs_audio = {};
    json_data["pairs"].forEach(function(currentValue, index, _) {
        pairs_audio[index] = currentValue["entries"][0]["pronunciations"][0]["soundData"];
    });
    let sound_data = json_data["pairs"][current_correct_answer_button]["entries"][0]["pronunciations"][0]["soundData"];
...
function set_pitch(json_data) {
    ...
    let moracount = json_data["pairs"][current_correct_answer_button]["entries"][0]["moraCount"];
...
async function fetch_random_pair() {
    ...
    let raw_pronunciation = json_data["pairs"][current_correct_answer_button]["entries"][0]["pronunciations"][0]["phrases"][0]["rawPronunciation"];
    let accented_mora = json_data["pairs"][current_correct_answer_button]["entries"][0]["pronunciations"][0]["phrases"][0]["accentedMora"];
